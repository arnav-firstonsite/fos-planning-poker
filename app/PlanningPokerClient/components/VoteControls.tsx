      ...
      {VOTE_OPTIONS.map((vote) => {
        ...
        return (
          <button
            ...
            className={`rounded-md border border-[hsl(var(--accent))]/30 px-3 py-2 text-sm font-semibold transition hover:-translate-y-0.5 focus:outline-none cursor-pointer disabled:cursor-not-allowed disabled:opacity-60 ${
              isSelected
